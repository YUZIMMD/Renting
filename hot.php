      ...
      <li class="list-item top-hover-box">
        <a href="" class="top-hover-link grade-one">您是房东</a>
          <ul class="top-hover">
            ...
            <li class=""><a href="mzhuce.php" rel="nofollow">房东注册</a></li>
...
right:0;
  ...
  ?>   	
		...
		<div class="com_main">
			<p class="title_cover">
				<span class="line"><img src="Picture/line-left.jpg" style="width:383px; height:7px"></span>
				<span class="title_word">最新上新，等你来选</span>
				<span class="line"><img src="Picture/line-right.jpg" style="width:383px;height:7px;"></span>
			</p>	
			...
			<div class="main_cover">
                                   <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'");
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
                               <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+1");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						     <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+2");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						     <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+3");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
 ...
 "> <?php echo $info1['name'];?>
					...
					<div class="bottom_img">
						<img src="Picture/bottom-p.jpg">
									...
									<div class="main_div">
			<div class="main_cover">
						<a href="house2.php?id=<?php echo $res['id']+4;?>">
                        <?php 
									$sql1=mysql_query("select * from house where id='".$res['id']."'+4");
                                    $info1=mysql_fetch_array($sql1);
									?>
							<img class="lazy" src="Picture/<?php echo $info1['img'];?>" alt="" title="<?php echo $info1['name'];?>
 "/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+5");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
 ...
 "> <?php echo $info1['name'];?> </dt>							
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+6");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+7");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
		...
		<div class="com_main">
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+8");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+9");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+10");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+11");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+12");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+13");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "><?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+14");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+15");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
		...
		<div class="com_main">
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+16");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+17");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+18");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+19");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+20");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+21");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+22");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+23");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
 ...
 "> <?php echo $info1['name'];?>
		...
		<div class="com_main">
           ...
           <div class="main_div">
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+24");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+25");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+26");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+27");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+28");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+29");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+30");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
...
"/>
 ...
 "> <?php echo $info1['name'];?>
			...
			<div class="main_cover">
						 <?php       
						            $sql2=mysql_query("select * from tb_hot where id='".$res['id']."'+31");
									$info2=mysql_fetch_array($sql2);
									$house_id = $info2['ino']; 
									$sql1=mysql_query("select * from house where id='".$house_id."'");
                                    $info1=mysql_fetch_array($sql1);
