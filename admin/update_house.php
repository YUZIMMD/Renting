...
<div class="container">
  ...
  <div class="panel-body">
      <form name="form1" method="post" id="upload_form" action="update_house_ok.php?id=<?php echo $_GET['update']?>&exid=<?php echo $_GET['exid']?>" method="post" enctype='multipart/form-data'>
