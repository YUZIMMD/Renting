...
<table cellspacing="1" class="table table-bordered">
  <tr bgcolor="#CCCCCC" >
    ...
    <td colspan="4" class="text-left">
      ...
      <td colspan="4"><a href="../zhuce.html" target="_blank">添加新用户</a></td>
  </tr>
  ...
  if(isset($_POST['select'])==true){
     ...
     $sql=mysql_query(" select * from tb_reader where name='".$_POST['key']."'");
  ...
  ?>
   <tr align="center" bgcolor="#FFFFFF">
    ...
    <tr>
      <td align="center" bgcolor="#FFFFFF" style="border-radius:10px" colspan="2"><label>所有用户信息</label></td>
    </tr>
    <tr style="height:10px;"></tr>
    <tr align="center" bgcolor="#CCCCCC">
      <th width="81">姓名</td>
      <th width="105">出生日期</td>
      <th width="65">证件类型</td>
      <th width="107">证件号码</td>
      <th width="89">电话</td>
      <th width="100">邮箱</td>
      <th width="37">备注</td>
      <th width="56">地址</td>
  ...
  include("Connections/conn.php");
  mysql_select_db('rent',$conn);
  $sql=mysql_query(" select * from tb_reader");
  ...
  do{
   ?>
    <tr align="center" bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FAF7F7'"onMouseOut="this.bgColor='#FFFFFF'">
      ...
      <td width="105"><?php echo $info['birthday'];?></td>
      <td width="65"><?php echo $info['paperType'];?></td>
      <td width="107"><?php echo $info['paperNO'];?></td>
      <td width="89"><?php echo $info['tel'];?></td>
      <td width="100"><?php echo $info['email'];?></td>
      <td width="37"><?php echo $info['remark'];?></td>
      <td width="56"><?php echo $info['address'];?></td>
      <td width="83"><a href="update_user.php?update=<?php echo $info['id'];?>" class="text-info"> 修改</a></td>
      <td width="69"><a href="delete_user.php?delete=<?php echo $info['name'];?>" class="text-danger"> 删除</a></td>
    </tr>
     <?php
