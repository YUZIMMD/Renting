...
<table border="0" cellspacing="1" class="table table-bordered">
  ...
  if(isset($_POST['select'])==true){
     ...
     $sql=mysql_query("select * from house where no='".$_POST['key']."' and rent =1");
  ...
  ?>
   <tr align="center" bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FAF7F7'"onMouseOut="this.bgColor='#FFFFFF'">
        ...
        <td><a href="update_house.php?update=<?php echo $info1['id'];?>&exid=1" class="text-info">修改</a></td>
    ...
    <tr align="center" bgcolor="#CCCCCC">
	  ...
	  include("Connections/conn.php");
	  mysql_select_db('rent',$conn);
	  $sql=mysql_query(" select * from house where rent=1");
   ...
   <tr align="center" bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FAF7F7'"onMouseOut="this.bgColor='#FFFFFF'">
       <td><?php echo $info['no'];?></td>
        ...
        <td><a href="update_house.php?update=<?php echo $info['id'];?>&exid=1" class="text-info">修改</a></td>
