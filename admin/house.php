...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h5">在线房源信息管理</h1>
</div>
...
<table border="0" cellspacing="1" class="table table-bordered">
  <tr bgcolor="#CCCCCC" >
    <td align="center" colspan="2">请选择查询条件：
      <select name="f2" class="form-contorl inline" id="f2">
        <option value="姓名"<?php if($result['no']=="姓名"){?> selected <?php }?>>编号</option>
      </select>
      </td>
    <td colspan="4">
  ...
  if(isset($_POST['select'])==true){
     ...
     $sql=mysql_query("select * from house where no='".$_POST['key']."'");
  ...
  ?>
   <tr align="center" bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FAF7F7'"onMouseOut="this.bgColor='#FFFFFF'">
        ...
        <td><a href="update_house.php?update=<?php echo $info1['id'];?>" class="text-info">修改</a></td>
    ...
    <tr align="center" bgcolor="#CCCCCC">
	  ...
	  include("Connections/conn.php");
	  mysql_select_db('rent',$conn);
	  $sql=mysql_query(" select * from house");
   ...
   ?>
    <tr align="center" bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FAF7F7'"onMouseOut="this.bgColor='#FFFFFF'">
       <td><?php echo $info['no'];?></td>
        ...
        <td><a href="update_house.php?update=<?php echo $info['id'];?>" class="text-info">修改</a></td>
