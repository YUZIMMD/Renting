...
<?php 
 mysql_connect("localhost","root","root");
  ...
  include("Connections/conn.php");
	...
	$query=mysql_query("select * from tb_reader where id='".$_GET['update']."'");
  ...
  <div class="row m-t-lg">
    <div class="col-sm-8 col-sm-offset-2">
      <div class="panel panel-info">
        <div class="panel-heading"><span style="color: #666">用户信息管理</span></div>
...
if(isset($_POST['submit'])==true){
	 mysql_query("SET NAMES 'utf8'"); 
$query=mysql_query("update tb_reader set sex='".$_POST['sex']."',vocation='".$_POST['vocation']."',birthday='".$_POST['birthday']."',paperType='".$_POST['paperType']."',paperNO='".$_POST['paperNO']."',tel='".$_POST['tel']."',email='".$_POST['email']."',remark='".$_POST['remark']."',address='".$_POST['address']."'where id='".$_GET['update']."'");
		if($query==true){
			echo "<script> alert('修改成功');window.location.href='admin_index.php?a=用户资料管理';</script>";
		}
	    else{
