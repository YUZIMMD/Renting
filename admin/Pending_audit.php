...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h5">待审核房源</h1>
</div>
...
<table border="0" cellspacing="1" class="table table-bordered">
  ...
  ?>
   <tr align="center" bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FAF7F7'"onMouseOut="this.bgColor='#FFFFFF'">
        ...
        <td><a href="update_house.php?update=<?php echo $info1['id'];?>&exid=2" class="text-info">修改</a></td>
   ...
   <tr align="center" bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FAF7F7'"onMouseOut="this.bgColor='#FFFFFF'">
       <td><?php echo $info['no'];?></td>
        ...
        <td><a href="update_house.php?update=<?php echo $info['id'];?>&exid=2" class="text-info">修改</a></td>
