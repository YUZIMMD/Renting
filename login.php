				...
				<div class="content" id="ejs_container">
					...
					<div class="form left">
						...
						<div class="form-list dib-wrap ">
							...
							<input id="yhm" name="yhm" data-exp="void-me" type="text" placeholder="您的账号" class="dib"/>
						</div>
						<div class="form-list dib-wrap ">
						...
						<div class="dib-wrap lh-37">
							<span class="font-bd"><a class="dib" href="zhuce.php"> 还没有账号？<span class="font-blue">立即注册</span></a></span>
						</div>
					</div>
				</div>
			</form>
...
if(isset($_POST['submit']))
{
	$a=$_POST['yhm'];
	$b=$_POST['mm'];
    $sql="select * from admin where user='".$a."' and pwd='".$b."'";//找到表
