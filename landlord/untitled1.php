...
<table border="0" cellspacing="1" class="table table-bordered">
  ...
  ?>
   <tr align="center" bgcolor="#FFFFFF" onMouseOver="this.bgColor='#9999CC'"onMouseOut="this.bgColor='#FFFFFF'">
         <td><?php echo $info1['no'];?></td>
          <td><a href="../house1.php?id=<?php echo $info1['id']?>"><?php echo $info1['name'];?></a></td>
          <td><?php echo $info1['price'];?></td>
          <td><?php echo $info1['area'];?></td>
          <td><?php echo $info1['struct'];?></td>
          <td><?php echo $info1['type'];?></td>
          <td><a href="update_house_manage.php?update=<?php echo $info1['id'];?>">修改</a></td>
          <td><a href="delete_house_delete.php?delete=<?php echo $info1['id'];?>">删除</a></td>
    </tr>
     <?php
	 }else{?>
  ...
  include("../Connections/conn.php");
   ...
   <tr align="center" bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FAF7F7'"onMouseOut="this.bgColor='#FFFFFF'">
          ...
          <td><a href="../house1.php?id=<?php echo $info['id']?>"><?php echo $info['name'];?></a></td>
          <td><?php echo $info['price'];?></td>
          <td><?php echo $info['area'];?></td>
          <td><?php echo $info['struct'];?></td>
          <td><?php echo $info['type'];?></td>
          <td><a href="update_house_manage.php?update=<?php echo $info['id'];?>">修改</a></td>
          <td><a href="delete_house_delete.php?delete=<?php echo $info['id'];?>">删除</a></td>
    </tr>
     <?php
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <tr align="center" bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FAF7F7'"onMouseOut="this.bgColor='#FFFFFF'">
          ...
          <td><a href="update_house_manage.php?update=<?php echo $info2['id'];?>">修改</a></td>
          <td><a href="delete_house_delete.php?delete=<?php echo $info2['id'];?>">删除</a></td>
    </tr>
     <?php
