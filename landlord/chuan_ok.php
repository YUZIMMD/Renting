...
$query1=mysql_query("insert into tb_matters(formName,no,result,advice)values('".$tableName."','".$_POST['no']."','".$result1."','".$advice."')");
		if($query==true){
			echo "<script> alert('录入房源成功');window.location.href='index.php?a=房产上传';</script>";
		}
	    else{
