...
<table border="0" cellspacing="1" class="table table-bordered">
    ...
    <tr>
      <td align="center" bgcolor="#FFFFFF" style="border-radius:10px"><label>房子评论</label></td>
    </tr>
  ...
  $info=mysql_fetch_array($sql);
   ...
   <tr align="center" bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FAF7F7'"onMouseOut="this.bgColor='#FFFFFF'">
      ...
      <td><a href="../house.php?id=<?php echo $info3['id']?>" target="_blank"><?php echo $info['no']?></a></td>
     ...
     ?>
      <tr style="height:20px"></tr>
    <tr>
      <td align="center" bgcolor="#FFFFFF" style="border-radius:10px"><label>给管理员的留言</label></td>
    </tr>
    <tr style="height:10px;"></tr>
    <tr align="center" bgcolor="">
          <th>历史发表留言</th>
