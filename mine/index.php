        ...
        <ul class="nav navbar-nav navbar-right m-r-md">
          <li class="dropdown">
            <a href="#"><img src="../Images/sun.png"/>
             欢迎来到home租房，亲爱的<?php echo $_SESSION['user'];?>
            </a>
          </li>
        </ul>
      </div>
    ...
    <div class="row m-t-xxl">
     <!-- 左侧导航 -->
      <div class="col-xs-3 b-a left_bar">
        ...
        <div class="name text-center">你好 <?php echo $_SESSION['user'];?></div>
        <div class="text-center nav_bar b-t">
           <a href="index.php?a=个人资料">我的个人资料</a>
        </div>
        <div class="text-center nav_bar b-t">
          <a href="index.php?a=房产预约登记">我的预约登记</a> 
        </div>
        <div class="text-center nav_bar b-t">
           <a href="index.php?a=房产租赁记录">历史租赁记录</a>
        </div>
        <div class="text-center nav_bar b-t">
           <a href="index.php?a=留言">留言</a>
        </div>
        <div class="text-center nav_bar b-t">
          <a href="index.php?a=退出">退出</a>
        </div>
        <div class="text-center nav_bar b-t">
...
<?php
	...
	echo "<script>alert('登录后才能预约租房，亲爱的，登录后再来吧！');window.location.href='http://localhost/zufang/login.php';</script>";
}
?>