        ...
        <div class="panel-body">
          <form id="form1" name="form1" method="post" action="">
            ...
            <div class="form-group b-b">
             ...
             <div class="form-group b-b">
              <label>房东电话号码：</label>
              <input type="text" name="mtel" class="form-control w-xxl inline  b-none" value="<?php echo $result['mtel'];?>" readonly>
            </div>
            <div class="form-group">
              <label>我预留的电话号码：</label>
              <input type="text" name="tel" class="form-control w-xxl inline" value="<?php echo $result['tel'];?>" placeholder="请填写电话号码" data-trigger="change"
                    ...
                    data-parsley-pattern-message="请输入正确的手机号码"><span class="text-danger">*</span>
...
$date=$_POST['date'];
$word=$_POST['word'];
$query=mysql_query("update tb_booking set tel='".$_POST['tel']."',word='".$_POST['word']."' where id='".$_GET['update']."'");
		if($query==true){
			echo "<script> alert('修改成功');window.location.href='index.php?a=房产预约登记';</script>";
		}
	    else{
